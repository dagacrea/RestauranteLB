  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/inicio" element={<LayoutGeneral><PaginaInicio /></LayoutGeneral>}/>
        <Route path="/menu" element={<LayoutGeneral><PaginaMenu /></LayoutGeneral>}/>
        <Route path="/reservas"element={<LayoutGeneral><PaginaReservas /></LayoutGeneral>}/>
        <Route path="/ventas"element={<LayoutGeneral><PaginaVentas reservas={reservas} menus={menus} /></LayoutGeneral>}/>
      </Routes>
    </Router>
  );
};
